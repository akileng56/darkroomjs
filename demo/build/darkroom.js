...
;(function () {
  ...
  Darkroom.plugins['zoom'] = Darkroom.Plugin.extend({
    ...
    initialize: function InitDarkroomBoxPlugin() {
      ...
      this.topButton = buttonGroup.createButton({
        image: 'hand'
      });
      ...
      this.bottomButton = buttonGroup.createButton({
        image: 'hand',
      });
      ...
      this.darkroom.addEventListener('zoom:change', this.zoomChange.bind(this));
      this.darkroom.addEventListener('core:transformation', this.restoreZoomPan.bind(this));
    ...
    _doPan: function (delta) {
      var image = this.darkroom.image;
      delta = this._constrainPan(delta);
    ...
    restoreZoomPan: function () {
      if (states.lastScale != null) {
        ...
        if (states.realPan != null) {
          this._doPan(states.realPan);
        }
      }
    },

    zoomChange: function () {
      states.lastScale = this.darkroom.image.scaleX;
    },
    ...
    zoomIn: function () {
      ...
      if (canvas.getZoom() <= maxZoom) {
        ...
        // this.darkroom.dispatchEvent('zoom:change');
      }
      this.updateButtons();
    },
